<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewPrescription.aspx.cs" Inherits="ViewPrescriptionPage" Title="Doctor home page" %>

<%@ Register Src="~/Admin/UserControls/EPrescriptionFieldsView.ascx" TagPrefix="uc1" TagName="EPrescriptionFieldsView" %>
            ...
            <asp:TemplateField HeaderText="Command">
                <ItemTemplate>
                  <%--  <asp:Button ID="btnClone" runat="server" Text="Clone" CommandName="Clone" CommandArgument='<%#Bind("PrescriptionId") %>'/>--%>
                    <asp:Button ID="btnReprint" runat="server" Text="View" CommandName="View" CommandArgument='<%#Bind("PrescriptionId") %>' />
                </ItemTemplate>
            </asp:TemplateField>
