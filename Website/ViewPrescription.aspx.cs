...
public partial class ViewPrescriptionPage : System.Web.UI.Page
{	
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "View")
        {
            ...
            string url = "EprescriptionEdit.aspx?PrescriptionId=" + presID;
            string script = String.Format("window.open('{0}','YourWindowName','HEIGHT=800,WIDTH=1300,resizable=no,scrollbars=yes,toolbar=yes,menubar=no,status=yes');", url);
