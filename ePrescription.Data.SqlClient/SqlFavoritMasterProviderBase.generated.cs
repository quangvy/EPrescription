...
/*
	...
	Important: Do not modify this file. Edit the file SqlFavoritMasterProvider.cs instead.
*/
...
namespace ePrescription.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlFavoritMasterProviderBase : FavoritMasterProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlFavoritMasterProviderBase"/> instance.
		/// </summary>
		public SqlFavoritMasterProviderBase()
		{
		}
	...
	public SqlFavoritMasterProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<FavoritMaster> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<FavoritMaster>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.FavoritMaster_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@IsPrivate", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				{
					database.SetParameterValue(commandWrapper, "@DiceaseName", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("createby ") || clause.Trim().StartsWith("createby="))
				{
					database.SetParameterValue(commandWrapper, "@CreateBy", 
				...
				if (clause.Trim().StartsWith("isprivate ") || clause.Trim().StartsWith("isprivate="))
				{
					database.SetParameterValue(commandWrapper, "@IsPrivate", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<FavoritMaster> rows = new TList<FavoritMaster>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of ePrescription.Entities.FavoritMaster objects.</returns>
		public override TList<FavoritMaster> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.FavoritMaster_Find_Dynamic", typeof(FavoritMasterColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<FavoritMaster> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.FavoritMaster_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of ePrescription.Entities.FavoritMaster objects.</returns>
		public override TList<FavoritMaster> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.FavoritMaster_GetPaged", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<ePrescription.Entities.FavoritMaster> entities)
		{
			...
			DataColumn col2 = dataTable.Columns.Add("CreateBy", typeof(System.String));
			col2.AllowDBNull = true;		
			DataColumn col3 = dataTable.Columns.Add("Diagnosis", typeof(System.String));
			col3.AllowDBNull = true;		
			DataColumn col4 = dataTable.Columns.Add("DiagnosisVN", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("IsPrivate", "IsPrivate");
			
			foreach(ePrescription.Entities.FavoritMaster entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["IsPrivate"] = entity.IsPrivate.HasValue ? (object) entity.IsPrivate  : System.DBNull.Value;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, ePrescription.Entities.FavoritMaster entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			...
			database.AddInParameter(commandWrapper, "@IsPrivate", DbType.Boolean, (entity.IsPrivate.HasValue ? (object) entity.IsPrivate  : System.DBNull.Value));
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, ePrescription.Entities.FavoritMaster entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
