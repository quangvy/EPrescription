...
namespace ePrescription.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@UserRole", DbType.String, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@MobilePhone", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("userrole ") || clause.Trim().StartsWith("userrole="))
				{
					database.SetParameterValue(commandWrapper, "@UserRole", 
						clause.Trim().Remove(0,8).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				if (clause.Trim().StartsWith("signature ") || clause.Trim().StartsWith("signature="))
				{
					database.SetParameterValue(commandWrapper, "@Signature", 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ePrescription.Entities.Users GetByUserName(TransactionManager transactionManager, System.String _userName, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<ePrescription.Entities.Users> entities)
		{
			...
			DataColumn col2 = dataTable.Columns.Add("UserRole", typeof(System.String));
			...
			foreach(ePrescription.Entities.Users entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, ePrescription.Entities.Users entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
            ...
            database.AddInParameter(commandWrapper, "@UserRole", DbType.String, entity.UserRole );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, ePrescription.Entities.Users entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
