/*
	...
	Important: Do not modify this file. Edit the file VrDoctorwip.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'Vr_Doctorwip' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VrDoctorwipBase")]
	public abstract partial class VrDoctorwipBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VrDoctorwipBase"/> instance.
		///</summary>
		public VrDoctorwipBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="VrDoctorwip"/> instance.
		///</summary>
		///<param name="_statId"></param>
		///<param name="_patientCode"></param>
		///<param name="_tid"></param>
		...
		///<param name="_isCompleted"></param>
		///<param name="_createDate"></param>
		public static VrDoctorwip CreateVrDoctorwip(System.Int64 _statId, System.String _patientCode, System.String _tid, System.String _firstName, System.String _lastName, System.DateTime _dob, System.String _sex, System.String _nationality, System.Boolean? _patientStart, System.String _vitalSign, System.String _lab, System.String _xray, System.String _ultraSound, System.String _cardiology, System.String _medReport, System.String _chargedCodes, System.Boolean? _isCompleted, System.DateTime? _createDate)
		{
			VrDoctorwip newVrDoctorwip = new VrDoctorwip();
			newVrDoctorwip.StatId = _statId;
			newVrDoctorwip.PatientCode = _patientCode;
			newVrDoctorwip.Tid = _tid;
			newVrDoctorwip.FirstName = _firstName;
			newVrDoctorwip.LastName = _lastName;
			newVrDoctorwip.Dob = _dob;
			newVrDoctorwip.Sex = _sex;
			newVrDoctorwip.Nationality = _nationality;
			newVrDoctorwip.PatientStart = _patientStart;
			newVrDoctorwip.VitalSign = _vitalSign;
			newVrDoctorwip.Lab = _lab;
			newVrDoctorwip.Xray = _xray;
			newVrDoctorwip.UltraSound = _ultraSound;
			newVrDoctorwip.Cardiology = _cardiology;
			newVrDoctorwip.MedReport = _medReport;
			newVrDoctorwip.ChargedCodes = _chargedCodes;
			newVrDoctorwip.IsCompleted = _isCompleted;
			newVrDoctorwip.CreateDate = _createDate;
			return newVrDoctorwip;
		}
		...
		///<summary>
		///  Returns a Typed VrDoctorwipBase Entity 
		///</summary>
		public virtual VrDoctorwipBase Copy()
		{
			//shallow copy entity
			VrDoctorwip copy = new VrDoctorwip();
		...
		///<returns>true if toObject is a <see cref="VrDoctorwipBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VrDoctorwipBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VrDoctorwipBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VrDoctorwipBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VrDoctorwipBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VrDoctorwipBase Object1, VrDoctorwipBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VrDoctorwip entity, string propertyName)
		{
			switch (propertyName)
			{
				case "StatId":
		...
		{			
			return GetPropertyValueByName(this as VrDoctorwip, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VrDoctorwip columns.
	/// </summary>
	[Serializable]
	public enum VrDoctorwipColumn
	{
		/// <summary>
		/// StatId : 
		/// </summary>
