/*
	...
	Important: Do not modify this file. Edit the file VrLabReq.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'Vr_LabReq' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VrLabReqBase")]
	public abstract partial class VrLabReqBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VrLabReqBase"/> instance.
		///</summary>
		public VrLabReqBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="VrLabReq"/> instance.
		///</summary>
		///<param name="_statId"></param>
		///<param name="_patientCode"></param>
		///<param name="_tid"></param>
		...
		///<param name="_chargedCodes"></param>
		///<param name="_createDate"></param>
		public static VrLabReq CreateVrLabReq(System.Int64 _statId, System.String _patientCode, System.String _tid, System.String _firstName, System.String _lastName, System.DateTime _dob, System.String _sex, System.String _nationality, System.Boolean? _patientStart, System.String _lab, System.String _chargedCodes, System.DateTime? _createDate)
		{
			VrLabReq newVrLabReq = new VrLabReq();
			newVrLabReq.StatId = _statId;
			newVrLabReq.PatientCode = _patientCode;
			newVrLabReq.Tid = _tid;
			newVrLabReq.FirstName = _firstName;
			newVrLabReq.LastName = _lastName;
			newVrLabReq.Dob = _dob;
			newVrLabReq.Sex = _sex;
			newVrLabReq.Nationality = _nationality;
			newVrLabReq.PatientStart = _patientStart;
			newVrLabReq.Lab = _lab;
			newVrLabReq.ChargedCodes = _chargedCodes;
			newVrLabReq.CreateDate = _createDate;
			return newVrLabReq;
		}
		...
		///<summary>
		///  Returns a Typed VrLabReqBase Entity 
		///</summary>
		public virtual VrLabReqBase Copy()
		{
			//shallow copy entity
			VrLabReq copy = new VrLabReq();
		...
		///<returns>true if toObject is a <see cref="VrLabReqBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VrLabReqBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VrLabReqBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VrLabReqBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VrLabReqBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VrLabReqBase Object1, VrLabReqBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VrLabReq entity, string propertyName)
		{
			switch (propertyName)
			{
				case "StatId":
		...
		{			
			return GetPropertyValueByName(this as VrLabReq, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VrLabReq columns.
	/// </summary>
	[Serializable]
	public enum VrLabReqColumn
	{
		/// <summary>
		/// StatId : 
		/// </summary>
