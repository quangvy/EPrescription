...
{
	///<summary>
	/// An object representation of the 'VR_LabResult' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VrLabResultBase")]
	public abstract partial class VrLabResultBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		///<summary>
		///  Returns a Typed VrLabResultBase Entity 
		///</summary>
		public virtual VrLabResultBase Copy()
		{
			//shallow copy entity
		...
		///<returns>true if toObject is a <see cref="VrLabResultBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VrLabResultBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VrLabResultBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VrLabResultBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VrLabResultBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VrLabResultBase Object1, VrLabResultBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VrLabResult entity, string propertyName)
		{
			switch (propertyName)
			{
				case "StatId":
		...
		{			
			return GetPropertyValueByName(this as VrLabResult, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VrLabResult columns.
	/// </summary>
	[Serializable]
