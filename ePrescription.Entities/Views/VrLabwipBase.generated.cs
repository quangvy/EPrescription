/*
	...
	Important: Do not modify this file. Edit the file VrLabwip.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'Vr_Labwip' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VrLabwipBase")]
	public abstract partial class VrLabwipBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VrLabwipBase"/> instance.
		///</summary>
		public VrLabwipBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="VrLabwip"/> instance.
		///</summary>
		///<param name="_id"></param>
		///<param name="_tid"></param>
		///<param name="_reqId"></param>
		...
		///<param name="_nationality"></param>
		///<param name="_reqStatus"></param>
		public static VrLabwip CreateVrLabwip(System.Int64 _id, System.String _tid, System.String _reqId, System.String _code, System.String _description, System.String _reqDoctor, System.Boolean? _billable, System.String _sample, System.DateTime? _colDate, System.TimeSpan? _colTime, System.DateTime? _reqDate, System.String _sampleType, System.String _providerType, System.Int64 _statId, System.String _patientCode, System.String _firstName, System.String _lastName, System.DateTime _dob, System.String _sex, System.String _nationality, System.String _reqStatus)
		{
			VrLabwip newVrLabwip = new VrLabwip();
			newVrLabwip.Id = _id;
			newVrLabwip.Tid = _tid;
			newVrLabwip.ReqId = _reqId;
			newVrLabwip.Code = _code;
			newVrLabwip.Description = _description;
			newVrLabwip.ReqDoctor = _reqDoctor;
			newVrLabwip.Billable = _billable;
			newVrLabwip.Sample = _sample;
			newVrLabwip.ColDate = _colDate;
			newVrLabwip.ColTime = _colTime;
			newVrLabwip.ReqDate = _reqDate;
			newVrLabwip.SampleType = _sampleType;
			newVrLabwip.ProviderType = _providerType;
			newVrLabwip.StatId = _statId;
			newVrLabwip.PatientCode = _patientCode;
			newVrLabwip.FirstName = _firstName;
			newVrLabwip.LastName = _lastName;
			newVrLabwip.Dob = _dob;
			newVrLabwip.Sex = _sex;
			newVrLabwip.Nationality = _nationality;
			newVrLabwip.ReqStatus = _reqStatus;
			return newVrLabwip;
		}
		...
		///<summary>
		///  Returns a Typed VrLabwipBase Entity 
		///</summary>
		public virtual VrLabwipBase Copy()
		{
			//shallow copy entity
			VrLabwip copy = new VrLabwip();
				copy.Id = this.Id;
				copy.Tid = this.Tid;
		...
		///<returns>true if toObject is a <see cref="VrLabwipBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VrLabwipBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VrLabwipBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VrLabwipBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VrLabwipBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VrLabwipBase Object1, VrLabwipBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VrLabwip entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Id":
		...
		{			
			return GetPropertyValueByName(this as VrLabwip, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VrLabwip columns.
	/// </summary>
	[Serializable]
	public enum VrLabwipColumn
	{
		/// <summary>
		/// Id : 
		/// </summary>
