/*
	...
	Important: Do not modify this file. Edit the file VrReceptionDone.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'VR_ReceptionDone' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VrReceptionDoneBase")]
	public abstract partial class VrReceptionDoneBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VrReceptionDoneBase"/> instance.
		///</summary>
		public VrReceptionDoneBase()
		{
		}		
		...
		///<summary>
		/// A simple factory method to create a new <see cref="VrReceptionDone"/> instance.
		///</summary>
		///<param name="_statId"></param>
		///<param name="_patientCode"></param>
		///<param name="_tid"></param>
		...
		///<param name="_chargedCodes"></param>
		///<param name="_createDate"></param>
		public static VrReceptionDone CreateVrReceptionDone(System.Int64 _statId, System.String _patientCode, System.String _tid, System.String _firstName, System.String _lastName, System.DateTime _dob, System.String _sex, System.String _nationality, System.Boolean? _patientStart, System.Boolean? _isCompleted, System.String _chargedCodes, System.DateTime? _createDate)
		{
			VrReceptionDone newVrReceptionDone = new VrReceptionDone();
			newVrReceptionDone.StatId = _statId;
			newVrReceptionDone.PatientCode = _patientCode;
			newVrReceptionDone.Tid = _tid;
			newVrReceptionDone.FirstName = _firstName;
			newVrReceptionDone.LastName = _lastName;
			newVrReceptionDone.Dob = _dob;
			newVrReceptionDone.Sex = _sex;
			newVrReceptionDone.Nationality = _nationality;
			newVrReceptionDone.PatientStart = _patientStart;
			newVrReceptionDone.IsCompleted = _isCompleted;
			newVrReceptionDone.ChargedCodes = _chargedCodes;
			newVrReceptionDone.CreateDate = _createDate;
			return newVrReceptionDone;
		}
		...
		///<summary>
		///  Returns a Typed VrReceptionDoneBase Entity 
		///</summary>
		public virtual VrReceptionDoneBase Copy()
		{
			//shallow copy entity
			VrReceptionDone copy = new VrReceptionDone();
		...
		///<returns>true if toObject is a <see cref="VrReceptionDoneBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VrReceptionDoneBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VrReceptionDoneBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VrReceptionDoneBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VrReceptionDoneBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VrReceptionDoneBase Object1, VrReceptionDoneBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VrReceptionDone entity, string propertyName)
		{
			switch (propertyName)
			{
				case "StatId":
		...
		{			
			return GetPropertyValueByName(this as VrReceptionDone, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VrReceptionDone columns.
	/// </summary>
	[Serializable]
	public enum VrReceptionDoneColumn
	{
		/// <summary>
		/// StatId : 
		/// </summary>
