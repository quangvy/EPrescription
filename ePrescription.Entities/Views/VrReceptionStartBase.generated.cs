/*
	...
	Important: Do not modify this file. Edit the file VrReceptionStart.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'VR_ReceptionStart' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VrReceptionStartBase")]
	public abstract partial class VrReceptionStartBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VrReceptionStartBase"/> instance.
		///</summary>
		...
		///<summary>
		/// A simple factory method to create a new <see cref="VrReceptionStart"/> instance.
		///</summary>
		///<param name="_statId"></param>
		///<param name="_patientCode"></param>
		///<param name="_tid"></param>
		...
		public static VrReceptionStart CreateVrReceptionStart(System.Int64 _statId, System.String _patientCode, System.String _tid, System.String _firstName, System.String _lastName, System.DateTime _dob, System.String _sex, System.String _nationality, System.Boolean? _patientStart, System.Boolean? _isCompleted, System.String _chargedCodes)
		{
			...
			newVrReceptionStart.PatientCode = _patientCode;
			newVrReceptionStart.Tid = _tid;
			newVrReceptionStart.FirstName = _firstName;
			newVrReceptionStart.LastName = _lastName;
			newVrReceptionStart.Dob = _dob;
			newVrReceptionStart.Sex = _sex;
			newVrReceptionStart.Nationality = _nationality;
		...
		///<summary>
		///  Returns a Typed VrReceptionStartBase Entity 
		///</summary>
		public virtual VrReceptionStartBase Copy()
		{
			//shallow copy entity
			VrReceptionStart copy = new VrReceptionStart();
		...
		///<returns>true if toObject is a <see cref="VrReceptionStartBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VrReceptionStartBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VrReceptionStartBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VrReceptionStartBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VrReceptionStartBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VrReceptionStartBase Object1, VrReceptionStartBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VrReceptionStart entity, string propertyName)
		{
			switch (propertyName)
			{
				case "StatId":
		...
		{			
			return GetPropertyValueByName(this as VrReceptionStart, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VrReceptionStart columns.
	/// </summary>
	[Serializable]
	public enum VrReceptionStartColumn
	{
		/// <summary>
		/// StatId : 
		/// </summary>
