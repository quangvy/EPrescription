...
namespace ePrescription.Web.UI
{
    ...
    public class GridViewSearchPanel : CompositeControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            cboOperator.Items.Add(new ListItem("range(; to split)", "4"));
        ...
        private void BuildSearch()
        {
            switch (cboOperator.SelectedValue)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    whereClause = string.Format("[{0}] BETWEEN '{1}' AND '{2}'", cboFieldName.SelectedValue, txtKeyword.Text.Split(';')[0], txtKeyword.Text.Split(';')[1]);
                    break;
            }
    ...
    public enum SearchOperator
    {
        ...
        EndsWith = 3,
        /// does an between search with ; split
        Range = 4
    }
}
