...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VrDoctorDoneRepeater</c>
    /// </summary>
	public class VrDoctorDoneRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VrDoctorDoneRepeaterDesigner"/> class.
        /// </summary>
		public VrDoctorDoneRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VrDoctorDoneRepeater))
			{ 
				throw new ArgumentException("Component is not a VrDoctorDoneRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VrDoctorDoneRepeater z = (VrDoctorDoneRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VrDoctorDoneRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VrDoctorDoneRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VrDoctorDoneRepeater runat=\"server\"></{0}:VrDoctorDoneRepeater>")]
	public class VrDoctorDoneRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VrDoctorDoneRepeater"/> class.
        /// </summary>
		public VrDoctorDoneRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VrDoctorDoneItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						ePrescription.Entities.VrDoctorDone entity = o as ePrescription.Entities.VrDoctorDone;
						VrDoctorDoneItem container = new VrDoctorDoneItem(entity);
	...
	public class VrDoctorDoneItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private ePrescription.Entities.VrDoctorDone _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VrDoctorDoneItem"/> class.
        /// </summary>
		public VrDoctorDoneItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VrDoctorDoneItem"/> class.
        /// </summary>
		public VrDoctorDoneItem(ePrescription.Entities.VrDoctorDone entity)
			: base()
		{
			_entity = entity;
		}
