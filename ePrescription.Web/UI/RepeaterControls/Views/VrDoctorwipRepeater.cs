...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VrDoctorwipRepeater</c>
    /// </summary>
	public class VrDoctorwipRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VrDoctorwipRepeaterDesigner"/> class.
        /// </summary>
		public VrDoctorwipRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VrDoctorwipRepeater))
			{ 
				throw new ArgumentException("Component is not a VrDoctorwipRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VrDoctorwipRepeater z = (VrDoctorwipRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VrDoctorwipRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VrDoctorwipRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VrDoctorwipRepeater runat=\"server\"></{0}:VrDoctorwipRepeater>")]
	public class VrDoctorwipRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VrDoctorwipRepeater"/> class.
        /// </summary>
		public VrDoctorwipRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VrDoctorwipItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						ePrescription.Entities.VrDoctorwip entity = o as ePrescription.Entities.VrDoctorwip;
						VrDoctorwipItem container = new VrDoctorwipItem(entity);
	...
	public class VrDoctorwipItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private ePrescription.Entities.VrDoctorwip _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VrDoctorwipItem"/> class.
        /// </summary>
		public VrDoctorwipItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VrDoctorwipItem"/> class.
        /// </summary>
		public VrDoctorwipItem(ePrescription.Entities.VrDoctorwip entity)
			: base()
		{
			_entity = entity;
		}
