...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VrLabwipRepeater</c>
    /// </summary>
	public class VrLabwipRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VrLabwipRepeaterDesigner"/> class.
        /// </summary>
		public VrLabwipRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VrLabwipRepeater))
			{ 
				throw new ArgumentException("Component is not a VrLabwipRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VrLabwipRepeater z = (VrLabwipRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VrLabwipRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VrLabwipRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VrLabwipRepeater runat=\"server\"></{0}:VrLabwipRepeater>")]
	public class VrLabwipRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VrLabwipRepeater"/> class.
        /// </summary>
		public VrLabwipRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VrLabwipItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						ePrescription.Entities.VrLabwip entity = o as ePrescription.Entities.VrLabwip;
						VrLabwipItem container = new VrLabwipItem(entity);
	...
	public class VrLabwipItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private ePrescription.Entities.VrLabwip _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VrLabwipItem"/> class.
        /// </summary>
		public VrLabwipItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VrLabwipItem"/> class.
        /// </summary>
		public VrLabwipItem(ePrescription.Entities.VrLabwip entity)
			: base()
		{
			_entity = entity;
		}
